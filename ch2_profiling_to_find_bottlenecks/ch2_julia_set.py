...
def calc_pure_python(desired_width, max_iterations):
    ...
    # easily be removed, we use it to simulate a real-world scenario
...
# untested
@profile
def calculate_z_serial_purepython_2(maxiter, x, y):
    """Calculate output list using Julia update rule optimized 1"""
    output = []
    for ycoord in y:
        for xcoord in x:
